...
public class TestEmpDao {
	...
	public void testInsert() throws SQLException {
		...
		Emp emp = new Emp("wangwu","wangwu","123456",
	...
	public void testInsertMany() throws SQLException {
		...
		for(int i =1;i<=20;i++){
			Emp emp = new Emp("jack" + i,"jack" + i,"123456","jack@163.com","12345678910",4700,Date.valueOf("1995-11-11"),dept,job,null,"1111");
			dao.insert(emp);
		}
